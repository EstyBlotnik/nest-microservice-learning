    ...
    @ApiBody({
        ...
        schema: {
            ...
            properties: {
                ...
                create_date: { type: 'string', format: 'date-time', example: '2025-12-01T12:00:00+02:00' },
                location: {
                    type: 'object',
                    properties: {
                ...
                alerts: { type: 'array', items: { type: 'number' }, example: [101, 202] },
                status: { type: 'integer', enum: [1, 2, 3, 4, 5, 6] },
                description: { type: 'string', example: 'אירוע בדיקה' },
            },
            required: ['id', 'name', 'create_date', 'location', 'status', 'description'],
        },
    })
